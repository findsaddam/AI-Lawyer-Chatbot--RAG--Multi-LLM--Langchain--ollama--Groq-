...
pdfs_directory = 'pdfs/'
llm_model=ChatGroq(api_key="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", model="deepseek-r1-distill-llama-70b")
...
user_query = st.text_area("Ask your Question: ", height=150 , placeholder= "Ask Anything!")
